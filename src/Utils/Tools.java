...
public class Tools {
    ...
    public static void successMessageValidation(){
        ...
        WebElement actualResult = GenelWebDriver.driver.findElement(By.cssSelector("[class=\"alert alert-success alert-dismissible\"]"));
        Assert.assertTrue(actualResult.getText().toLowerCase().contains("success"));
